...
export function NewCustomerForm() {
  ...
  /**
   * Stays busy through `isSuccess` on the create: the redirect has not painted
   * yet, and a button that springs back to clickable invites a second submit.
   */
